...
import { AuthControls } from "@/src/components/auth/common/AuthControls";
...
const VerifyOtp = () => {
  ...
  return (
    <div 
      className="min-h-screen dark:bg-none dark:bg-[var(--page-body-bg)] flex items-center justify-center p-4"
      style={{
