      ...
      <DialogContent className="sm:max-w-xl! max-w-[calc(100%-2rem)]! bg-white dark:bg-(--card-color) border-none rounded-lg p-0 overflow-hidden shadow-2xl">
        <DialogHeader className="p-4 pb-0">
          <DialogTitle className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-3">
            <div className="p-2 bg-(--light-primary) dark:bg-(--text-green-primary)/15 rounded-lg">
        ...
        <div className="sm:p-6 p-4 space-y-6 pt-0! max-h-[250px] overflow-auto custom-scrollbar">
          ...
          <div className="space-y-2 flex flex-col relative">
            ...
            <div className="relative group">
              ...
              {response && (
                <Button type="button" size="icon" variant="ghost" onClick={copyToClipboard} className="absolute right-3 top-3 h-8 w-8 text-slate-400 hover:text-(--text-green-primary) hover:bg-(--text-green-primary)/10 dark:hover:bg-(--text-green-primary)/15 transition-all opacity-0 group-hover:opacity-100">
