              ...
              <Card className="border shadow-sm dark:bg-(--card-color) bg-white rounded-lg h-fit">
                <CardHeader className="flex flex-row items-center justify-between py-5 border-b border-slate-50 dark:border-(--card-border-color) px-6">
                  ...
                  <Button
                    ...
                    size="sm"
                    variant="ghost"
                    className="text-(--text-green-primary) border border-(--text-green-primary) dark:border-none hover:bg-(--text-green-primary)/10 dark:bg-page-body dark:hover:bg-(--dark-sidebar) hover:text-(--text-green-primary) h-9 px-4 rounded-lg font-bold"
                    onClick={() => {
              ...
              <Card className="border shadow-sm dark:bg-(--card-color) bg-white rounded-lg h-fit">
                <CardHeader className="flex flex-row items-center justify-between py-5 border-b border-slate-50 dark:border-(--card-border-color) px-6">
                  ...
                  <Button
                    ...
                    size="sm"
                    variant="ghost"
                    className="text-(--text-green-primary) border border-(--text-green-primary) dark:border-none dark:bg-page-body hover:bg-(--text-green-primary)/10 dark:hover:bg-(--dark-sidebar) hover:text-primary h-9 px-4 rounded-lg font-bold"
                    onClick={() => {
                ...
                <CardContent className="sm:p-6 p-4 space-y-6">
                  ...
                  {values.payloadType === "json" ? (
                    <div className="space-y-2 flex flex-col">
                      ...
                      <Field name="payloadJson" as={Textarea} placeholder="Enter JSON payload structure.." className="min-h-40 font-mono text-sm border-none bg-slate-950 text-(--text-green-primary) rounded-lg p-6 focus:ring-1 focus:ring-(--text-green-primary)/50" />
                    </div>
                  ) : (
                ...
                <CardContent className="p-4">
                  ...
                  <div className="pt-2 space-y-4">
                    ...
                    <div className="flex justify-between items-center py-3 mb-2 last:p-0 border-b border-(--input-border-color) dark:border-(--card-border-color)">
                      ...
                      <span className="inline-flex items-center justify-center min-w-7 h-7 px-2.5 bg-(--text-green-primary)/10 dark:bg-(--text-green-primary)/15 text-(--text-green-primary) rounded-full font-bold text-sm">{values.headerList.filter((h) => h.key).length}</span>
                    </div>
