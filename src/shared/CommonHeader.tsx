        ...
        <div className="flex items-center gap-3 flex-wrap justify-end">
          ...
          {onAddClick && (
            <Can permission={addPermission}>
              <Button onClick={onAddClick} className="flex items-center cursor-pointer gap-2 justify-center text-white px-4.5 py-5 rounded-lg dark:shadow-none shadow-md shadow-blue-100 transition-all active:scale-95">
